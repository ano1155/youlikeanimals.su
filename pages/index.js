...
export default function Home({
  ...
  const elements = metas.map((meta, i) => (
  ...
  if (typeof window !== "undefined" && url !== "/" && !isClient) {
    ...
    <div className="Home_container__bCOhY">
      <div
        style={{
          ...
          maxWidth: "800px",
          background: "white",
          boxShadow: "rgb(136, 136, 136) 5px 5px 5px",
        }}
      >
        <div>
          <div></div>
  ...
  return (
    <div className={styles.container}>
      <Head>{elements}</Head>
      <main>{clientSideComponents}</main>
    </div>
  );
}
...
Home.getInitialProps = async (props) => {
  ...
  let isClient = true;
  if (
    props.req.headers.referer?.match(
